...
public class Des3 {
    ...
    String encryptString(String text) {
        try {
            ...
            e.printStackTrace();
            AlertDialog.showError("3DES text encryption error", e.toString());
            return null;
        }
    }
    ...
    void encryptFile(File in, File out) {
        try {
            ...
            e.printStackTrace();
            AlertDialog.showError("3DES init error!", e.toString());
            return;
        }
        ...
        try {
            ...
            e.printStackTrace();
            AlertDialog.showError("3DES file encryption error!", e.toString());
        }
    }
    ...
    void decryptFile(File in, File out) {
        ...
        try {
            ...
            e.printStackTrace();
            AlertDialog.showError("3DES file decryption error!", e.toString());
            return;
